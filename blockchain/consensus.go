...
import (
    "log"
    "math/rand" // easily hacked this is for example only
	//"crypto/rand"
	// math/big
    "time"
)
...
// 2. Generate a random number between 0 and totalStake
...
func ProofOfStake(validators map[string]*POSValidator) string {
    ...
    // Step 2: Generate a random number in the range [0, totalStake)
